...
def create_default_weapons():
    ...
    weapons['knife'] = MeleeWeapon('Knife', 15, 2, 40, 4, (180, 180, 180))
    weapons['sword'] = MeleeWeapon('Sword', 25, 1.5, 60, 6, (160, 160, 165))
    weapons['axe'] = MeleeWeapon('Axe', 35, 2, 50, 8, (140, 100, 60))
    weapons['machete'] = MeleeWeapon('Machete', 20, 1.8, 55, 5, (120, 120, 120))
    weapons['bat'] = MeleeWeapon('Bat', 15, 2.5, 45, 5, (139, 90, 43))
    weapons['chain'] = MeleeWeapon('Chain', 10, 3, 60, 3, (100, 100, 100))
    weapons['hammer'] = MeleeWeapon('Hammer', 40, 3, 35, 10, (80, 80, 90))
    weapons['wrench'] = MeleeWeapon('Wrench', 15, 2, 35, 4, (150, 150, 160))
    weapons['saw'] = MeleeWeapon('Buzzsaw', 30, 1, 30, 6, (200, 150, 50))
    weapons['spear'] = MeleeWeapon('Spear', 20, 1.5, 70, 3, (139, 119, 94))
    
    weapons['pistol'] = Firearm('Pistol', 20, 0.5, 500, 15, 12, (80, 80, 85))
    weapons['rifle'] = Firearm('Rifle', 25, 0.3, 800, 20, 30, (70, 70, 75))
    weapons['shotgun'] = Firearm('Shotgun', 15, 1, 200, 12, 8, (60, 60, 65))
    weapons['smg'] = Firearm('SMG', 10, 0.1, 400, 18, 50, (75, 75, 80))
    weapons['sniper'] = Firearm('Sniper', 60, 2, 1500, 30, 5, (50, 50, 55))
    weapons['minigun'] = Firearm('Minigun', 8, 0.05, 600, 22, 200, (90, 90, 95))
    weapons['rocket_launcher'] = Firearm('Rocket Launcher', 100, 3, 1000, 10, 5, (100, 80, 50))
    
    weapons['grenade'] = Explosive('Grenade', 50, 100, 90)
    weapons['c4'] = Explosive('C4', 80, 150, 0)
    weapons['dynamite'] = Explosive('Dynamite', 60, 120, 180)
    weapons['mine'] = Explosive('Land Mine', 40, 80, 0)
    weapons['nuke'] = Explosive('Mini Nuke', 200, 300, 300)
